import { getGameNumberNotation, setGameNumberNotation, addGameNumberNotationChangeListener, GAME_NUMBER_NOTATIONS, formatGameNumber, } from '../scripts/core/formatting.js';
import { writeStorage, readStorage, NOTATION_STORAGE_KEY, GLYPH_EQUATIONS_STORAGE_KEY, DAMAGE_NUMBER_TOGGLE_STORAGE_KEY, DAMAGE_NUMBER_MODE_STORAGE_KEY, WAVE_KILL_TALLY_STORAGE_KEY, WAVE_DAMAGE_TALLY_STORAGE_KEY, GRAPHICS_MODE_STORAGE_KEY, TRACK_RENDER_MODE_STORAGE_KEY, TRACK_TRACER_TOGGLE_STORAGE_KEY, TOWER_LOADOUT_SLOTS_STORAGE_KEY, FRAME_RATE_LIMIT_STORAGE_KEY, FPS_COUNTER_TOGGLE_STORAGE_KEY, PLAYFIELD_ENEMY_PARTICLES_STORAGE_KEY, PLAYFIELD_EDGE_CRYSTALS_STORAGE_KEY, PLAYFIELD_BACKGROUND_PARTICLES_STORAGE_KEY, AUTO_GRAPHICS_TOGGLE_STORAGE_KEY, CRYSTAL_BACKGROUND_SPRITES_STORAGE_KEY, INVERT_CAROUSEL_DRAG_STORAGE_KEY, } from './autoSave.js';
...
export function applyDamageNumberMode(mode, { persist = true } = {}) {
    const normalizedMode = mode === DAMAGE_NUMBER_MODES.DAMAGE || mode === DAMAGE_NUMBER_MODES.REMAINING
        ? mode
