 ...
 * @returns True if all prologue levels are completed or tutorial was marked as done.
 */
 ...
 */
export function loadTutorialState(): void {
 ...
 * @returns True if the level is part of the prologue.
 */
export function isPrologueLevel(levelId: string): boolean {
  return PROLOGUE_LEVEL_IDS.includes(levelId);
}

/**
 * Get the list of prologue level IDs.
 * @returns Array of prologue level IDs.
 */
export function getPrologueLevelIds(): string[] {
 ...
 * @param isLevelCompletedFn - Function to check if a level is completed.
 */
export function checkTutorialCompletion(isLevelCompletedFn: (levelId: string) => boolean): void {
 ...
 * @returns True if the Towers tab is unlocked.
 */
export function isTowersTabUnlocked(): boolean {
 ...
 * @returns True if the Codex is unlocked.
 */
export function isCodexUnlocked(): boolean {
 ...
 */
export function unlockCodex(): void {
  codexUnlocked = true;
 ...
 * @returns True if the Achievements tab is unlocked.
 */
export function isAchievementsUnlocked(): boolean {
 ...
 */
export function unlockAchievements(): void {
  achievementsUnlocked = true;
