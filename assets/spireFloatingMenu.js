...
export function createSpireFloatingMenuController(options = {}) {
     ...
     */
    const { formatGameNumber = (value) => String(value ?? 0), formatWholeNumber = (value) => String(value ?? 0), getCurrentIdleMoteBank = () => 0, getCurrentFluidDropBank = () => 0, getLamedSparkBank = () => 0, getTsadiParticleBank = () => 0, getShinGlyphs = () => 0, getKufGlyphs = () => 0, isFluidUnlocked = () => false, isLamedUnlocked = () => false, isTsadiUnlocked = () => false, isShinUnlocked = () => false, isKufUnlocked = () => false, setActiveTab = () => { }, playMenuSelectSfx = () => { }, } = options;
    /**
     ...
     */
    function refreshLockableSpireItems(doc, selector, isUnlocked) {
