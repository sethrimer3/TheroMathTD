...
function readUpgradeLevel(state, key) {
...
export const beta = {
    ...
    variables: [
        ...
        // Derived slow percentage surfaced as its own sub-equation box for clarity.
        {
            ...
            computeValue({ blueprint, towerId }) {
                const effectiveBlueprint = blueprint || requireHelper('getTowerEquationBlueprint')(towerId);
                const bet1 = mathMaxWithUnknown(0, requireHelper('computeTowerVariableValue')(towerId, 'betSlow', effectiveBlueprint));
                ...
                return [
                    {
                        ...
                        values: String.raw `\( ${formatDecimal(durationSeconds, 2)} = 0.5 + 0.1 \times ${formatWholeNumber(glyphRank)} \)`,
                    },
                ];
            },
        },
