...
/** Preserve the dormant live-context power resolver for later Phi consumers. */
function _resolvePhiPower(): number {
  const helpers = ctx();
...
/** Fibonacci seed-burst blueprint for the Phi tower. */
export const phi = {
