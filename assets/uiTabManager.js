...
const STAGE_TAB_ICON_FRAME_URLS = Array.from({ length: STAGE_TAB_ICON_TOTAL_FRAMES }, (_, index) => new URL(`./sprites/menu/StageIconAnimation/StageIconAnimation (${index + 1}).png`, import.meta.url).href);
...
export function configureTabManager({ getOverlayActiveState, isFieldNotesOverlayVisible: fieldNotesOverlayFn, onTabChange: tabChangeFn, onTowerTabActivated: towerTabFn, playTabSelectSfx: playSfxFn, } = {}) {
    isOverlayActive =
